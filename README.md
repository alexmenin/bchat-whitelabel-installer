...
sudo ./install-online.sh agilizesolucoes/bchat-whitelabel:1.2.3 3388
```
...
sudo git pull
sudo ./bchatctl update-online agilizesolucoes/bchat-whitelabel:1.2.3
```
...
A versao `1.2.3` remove o codigo de setup e libera o fluxo diretamente pela
ativacao da licenca,
